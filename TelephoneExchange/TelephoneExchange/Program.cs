...
namespace TelephoneExchange
{
    class Program
    {
        ...
        static void AddSomeClients(CommunicationCompany company)
        {
            ...
            PersonContract Contract = new PersonContract(2456, Client, new JustCallAndPayTariffPlan(), 297689245);
            company.AddContract(Contract);
            Client = new PersonSubscriber(1002, "Andrey", "Ignatovich", new DateTime(1983, 2, 5), "KH132584");
            Contract = new PersonContract(2456, Client, new JustCallAndPayTariffPlan(), 297689245);
            company.AddContract(Contract);
